 ...
 * @author sonho
 */
public class ViewAddIncome extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdicionarDespesa
     */
    public ViewAddIncome() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAddIncome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAddIncome().setVisible(true);
            }
        });
    }
