 ...
 * @author sonho
 */
public class ViewAddExpenditure extends javax.swing.JFrame {

    /**
     * Creates new form TelaAdicionarDespesa
     */
    public ViewAddExpenditure() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAddExpenditure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAddExpenditure().setVisible(true);
            }
        });
    }
